...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("07382084-848f-4a90-9162-424250a7f44b", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Killing application containing item 'MainPage'.", repo.MainPage.SelfInfo, new RecordItemIndex(0));
            Host.Current.KillApplication(repo.MainPage.Self);
